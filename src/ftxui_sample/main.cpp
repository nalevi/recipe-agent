...
// configuration step. It creates a namespace called `recipe_agent`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", recipe_agent::cmake::project_name, recipe_agent::cmake::project_version) };
